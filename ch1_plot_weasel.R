...
png(filename = "weasel.png", width=10, height = 10, units = "cm", res = 600, type = "cairo")
...
for (i in unique(df$nrun)) lines(y=df[df$nrun==i,]$fitness,x=df[df$nrun==i,]$ngen, lwd=1, col = adjustcolor(1,0.5), lty= "dotted")
